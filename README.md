...
A simple static landing page for a fictional bakery. The site lives in the `bakery-landing-page-main/` directory and uses HTML, SCSS, and a bit of JavaScript.
...
```bash
npm install -g sass
sass app/scss:dist --watch
```

This watches the SCSS files and outputs updated CSS into `dist/`.
